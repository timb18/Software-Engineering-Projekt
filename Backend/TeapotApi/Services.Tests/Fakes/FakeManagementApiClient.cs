...
public class FakeManagementApiClient : IManagementApiClient
{
    public FakeManagementApiClient(List<UserResponseSchema> users)
    {
        this.Users = new FakeUsersClient(users);
    }
