...
public class InvitationRepository(TeapotDbContext context) : IInvitationRepository
{
    ...
    {
        return await context.Invitations.FindAsync([id], cancellationToken);
    }

    public Task<Invitation?> FindOpenAsync(Guid organizationId, string normalizedEmail,
        CancellationToken cancellationToken = default)
    {
        return context.Invitations.FirstOrDefaultAsync(i =>
    ...
    public async Task<IEnumerable<Invitation>> GetPendingForEmailAsync(string normalizedEmail,
        CancellationToken cancellationToken = default)
    {
    ...
    public async Task<IEnumerable<Invitation>> GetForOrganizationAsync(Guid organizationId,
        CancellationToken cancellationToken = default)
    {
        return await context.Invitations
            .Include(i => i.Organization)
    ...
    public async Task UpdateRangeAsync(IEnumerable<Invitation> invitations,
        CancellationToken cancellationToken = default)
    {
