...
public interface IWorkProfileRepository
{
    ...
    /// </summary>
    Task<WorkProfile?> GetByUserAndOrganizationAsync(Guid userId, Guid organizationId,
        CancellationToken cancellationToken = default);

    /// <summary>
    ///     Gets the user's work profile for one organization membership without tracking changes.
    /// </summary>
    Task<WorkProfile?> GetByUserAndOrganizationNoTrackingAsync(Guid userId, Guid organizationId,
        CancellationToken cancellationToken = default);
    ...
    Task<IReadOnlyList<WorkProfileTimeInterval>> GetTimeIntervalsAsync(Guid workProfileId,
        CancellationToken cancellationToken = default);
