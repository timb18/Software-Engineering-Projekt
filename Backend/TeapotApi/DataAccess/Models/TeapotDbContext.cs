...
/// <summary>
/// Entity Framework Core database context for the Teapot application.
/// Manages all database entities, their relationships, and configurations.
/// </summary>
/// <remarks>
/// The Teapot database is built on PostgreSQL and includes:
/// - User management (users, organization memberships, invitations)
/// - Organization/team management
/// - Work schedule configuration (work profiles, daily schedules, work blocks and breaks)
/// - Task management (user tasks, dependencies, scheduling blocks)
/// 
/// Enum types are stored as PostgreSQL native enums (invitation_status, role, task_priority, task_intensity).
/// All tables use UUID primary keys generated by PostgreSQL (gen_random_uuid()).
/// Cascading deletes are configured for dependent entities.
/// </remarks>
public partial class TeapotDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // These are stored as native PostgreSQL enums for type safety in the database
        modelBuilder
